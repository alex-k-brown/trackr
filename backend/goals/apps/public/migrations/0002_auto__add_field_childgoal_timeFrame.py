...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChildGoal.timeFrame'
        db.add_column(u'public_childgoal', 'timeFrame',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['public.TimeFrame']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChildGoal.timeFrame'
        db.delete_column(u'public_childgoal', 'timeFrame_id')
